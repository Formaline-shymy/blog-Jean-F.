...
// transmition in admin panel
    ...
    public function addComment($data){
        ...
        $this->db->query('INSERT INTO comments (post_id, comm_id, author, content) VALUES(:post_id , :comm_id, :author , :content) ORDER BY date_comm DESC');
        // Bind values
        $this->db->bind(':post_id', $data['post_id']);
        $this->db->bind(':comm_id', $data['comm_id']);
