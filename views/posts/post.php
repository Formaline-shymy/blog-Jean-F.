...
<!-- Show comment/comments -->
        ...
        <div class=showcomments">
          <?php foreach ($data['commentsByPostId'] as $commentByPostId): ?>
           <!-- <form action="<?php echo URLROOT; ?>/Posts/flag/<?php echo $data['comments']->post_id; ?>"method="post">     -->
                 ...
                 <div class ="row"> 
                  <div class="col-9 d-flex">
                   ...
                   <input type= "submit" class= "btn btn-sm btn-link text-decoration-none text-dark" value ="Signaler ce commentaire"> </span>    
                </div>
