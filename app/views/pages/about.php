      ...
      <h1 class="text-left"><?php echo $data['title']; ?></h1>
         ...
         <div class="text-center">
          ...
          <div class="text-justify">
             <p>Jean Forteroche est né en 1977 à Arras. Il vit aujourd'hui dans le Pas-de-Calais. Rien ne le prédestinait  à l'écriture, si ce n'est une imagination foisonnante et le besoin de raconter des histoires.
            <br><br>
