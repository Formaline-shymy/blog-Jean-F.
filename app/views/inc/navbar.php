<navbar>
  <div id="mySidenav" class="sidenav">
      ...
      <a href= "<?php echo URLROOT; ?>/about">Biographie</a>
      <a href="<?php echo URLROOT; ?>/posts/index">Lire des chapitres de Billet simple pour l'Alaska</a>
      <a href="<?php echo URLROOT; ?>/biblio">Romans</a>
